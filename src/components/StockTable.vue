...
<!--          <template #default="scope">-->
<!--&lt;!&ndash;            <el-text :style="{color:judgeMaState(scope.row)[1],fontSize:'15px',fontWeight:'bold'}" >{{judgeMaState(scope.row)[0]}}</el-text>&ndash;&gt;-->
...
<!--        >-->
<!--          <template #default="scope">-->
<!--&lt;!&ndash;            <div v-let="{ text, styleClass } = getAdvise(scope.row)">&ndash;&gt;-->
<!--&lt;!&ndash;              <el-text :class="styleClass" >{{text}}</el-text>&ndash;&gt;-->
<!--&lt;!&ndash;            </div>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-text :class="getAdvise(scope.row)[1]" >{{getAdvise(scope.row)[0]}}</el-text>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-tag :class="getAdvise(scope.row)[1]" >{{getAdvise(scope.row)[0]}}</el-tag>&ndash;&gt;-->
<!--            <el-tag>测试</el-tag>-->
<!--          </template>-->
<!--        </el-table-column>-->
<!--      </el-table>-->
...
<!--        :options="options"-->
<!--    >-->
<!--      <context-menu-item label="置顶" @click="test" />-->
...
<!--&lt;!&ndash;      <context-menu-group label="Menu with child">&ndash;&gt;-->
<!--&lt;!&ndash;        <context-menu-item label="删除" @click="onMenuClick(2)" />&ndash;&gt;-->
<!--&lt;!&ndash;        <context-menu-item label="Item2" @click="onMenuClick(3)" />&ndash;&gt;-->
<!--&lt;!&ndash;      </context-menu-group>&ndash;&gt;-->
<!--    </context-menu>-->
<!--  </div>-->
